...
После запуска программы экран становится затемнённым, и пользователь может с помощью мыши выбрать область для создания скриншота. При выборе области с зажатой клавишей \<Alt>, можно выбрать для скриншота окна, раскрытые на рабочем столе.
...
**`Стрелка`** \<F1>  
Рисует стрелку заданным цветом. Во время рисования стрелки можно модифицировать ее вид, вращая колесо мыши. Возможны следующие модификации: стрелка вперед, стрелка назад, стрелка в обе стороны. Нажатие клавиши \<Shift> во время рисования позволяет рисовать стрелку под фиксированным углом.
...
- Изменение размера метки: `Ctrl + Колесо мыши`
- Установка метки: клик левой кнопкой мыши в нужном месте
- Выход из режима: клавиша `Esc` или `Правая кнопка мыши`
