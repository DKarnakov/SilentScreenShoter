...
**\<Ctrl+P>**  
Отправка окна редактора на принтер. В окне предпросмотра печати мышкой можно отредактироать положение скриншота на листе, а также колесом мыши отрдактировать егот масштаб.

**\<Ctrl+M>**  
Установка на скриншоте метки - зеленая галочка, либо красный крестик. Выбор типа метки с помощью вращения `Колеса мыши`. Изменение размера метки - `Ctrl + Колесо мыши`. Выход и режима установки метки - `Esc`.
