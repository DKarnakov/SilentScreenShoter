...
**\<Ctrl+P>**  
Отправка окна редактора на принтер. В окне предпросмотра печати мышкой можно отредактироать положение скриншота на листе, а также колесом мыши отрдактировать его масштаб.
